...
public class PreferenceUtils {
    ...
    public void setDefaultValues(){
        ...
        if(!getBoolean(PREF_DEFAULTS_SET)) {
            Log.d(APP_PREFERENCES, "PREF_DEFAULTS_SET");
            storeBoolean(PREF_DEFAULTS_SET, true);

            storeInt(Types.RAMSCH, 10);
            storeInt(Types.POTT, 10);
            storeInt(Types.PFLICHT, 10);
            storeInt(Types.SAUSPIEL, 10);
            storeInt(Types.FARBSOLO, 50);
            storeInt(Types.WENZ, 50);
            storeInt(Types.GEIER, 50);
            storeInt(Types.BETTEL, 50);

            storeInt(Types.KLOPFEN, 10);
            storeInt(Types.LAUFENDE, 10);
            storeInt(Types.SCHNEIDER, 10);
            storeInt(Types.SCHWARZ, 10);
        }
    }
